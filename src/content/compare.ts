...
export const COMPARE_DOC: PageDoc = {
  ...
  lede: `Workout apps split into three kinds. Trackers such as Hevy and Strong record what you chose to do, set by set. Planners such as Fitbod and JEFIT decide or suggest the workout for you. Isofit is a tracker with two additions: you can log in plain language by typing or speaking, and you can ask Atlas, an AI coach built into the app, about your own history. This page compares Isofit with ${ALL_NAMES} using only what each company publishes about itself.`,
  sections: [
    {
      id: "overview",
      label: "Overview",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: [
        "Isofit includes Atlas, a chat-based AI coach built into the app that can read your training log. Hevy offers an AI chat too, as a Hevy app inside ChatGPT that reads your Hevy history, so the chat happens in ChatGPT rather than in Hevy. Strong advertises no coaching, and Fitbod and JEFIT describe workout generation without a chat.",
      ],
    },
    {
