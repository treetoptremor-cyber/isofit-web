...
export const TIER_CARDS = [
  {
    ...
    items: [
      "Unlimited logging by tap and Quicklog, with routines and full history",
      "Apple Health import, data export and account deletion",
  ...
  },
  {
    ...
    items: [
      "Everything in Free, plus the full body graph",
      "Atlas: 30 messages a day, 100 deep-analysis requests a month, saved programs and SITREP (weekly training review)",
  ...
  sections: [
    {
      ...
      table: {
        ...
        rows: [
          ...
          ["Voice logging", "0.05 $ISO an entry; blocked at a zero balance; usage limits apply", "0.05 $ISO an entry; blocked at a zero balance; usage limits apply"],
    ...
    },
    {
      ...
      specs: [
        ...
        { term: "Voice logging", value: "Voice logging powered by earned $ISO. Each successfully processed voice entry costs 0.05 $ISO on all plans and requires sufficient balance: with no $ISO the voice log is blocked, and a failed entry is refunded. Usage limits apply." },
