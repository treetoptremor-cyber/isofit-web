...
export const COMPETITORS: Competitor[] = [
  {
    ...
    rows: {
      ...
      coaching:
        "Hevy Trainer (Pro) generates a program and suggests progressive overload. Hevy says these programs are generated by an algorithm and do not rely on AI. No AI chat is advertised.",
