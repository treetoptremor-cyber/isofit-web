...
export const metadata = {
  title: "Research Information Sheet | Isofit",
  description: "What joining Isofit's research means: what is studied, what data is included, how it is de-identified, and how to withdraw.",
};

const POLICY_PATH = path.join(process.cwd(), "src/app/research/research-information-sheet.md");
