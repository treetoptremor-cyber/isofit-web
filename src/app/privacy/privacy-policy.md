...
### 2.4 Limits on Data Collection and Storage

We do not store your precise GPS location. Optional device location access for weather is described in Section 6.2.

We do not collect or store:

- Data from your contacts, calendar, or camera roll unless you explicitly choose to upload a photo or video.
- Full payment card details. Apple processes App Store payments, and RevenueCat manages subscription status.
- Data from external social media platforms.
...
- **Purpose limitation.** HealthKit data is used only to provide Isofit features for you: importing your workouts into your log, showing your recent daily summaries, and — if you have opted in to Atlas personalization — giving Atlas the same picture of your week when it coaches you.
...
- **No AI training.** Your HealthKit data is never used to train AI models. It is processed by our AI provider only to generate your coaching responses, under terms that prohibit the provider from training on it.
- **No disclosure without permission.** We do not disclose your HealthKit data to any third party without your express permission. The service providers that process it on our behalf are listed in Section 6.2.
...
- **Consent records:** When you grant or withdraw a consent — accepting the Terms, consenting to health-data processing, or opting in to Atlas personalization, for example — we record which consent, the version of the text you saw, when, and a hashed IP address and device identifier. We keep these records as evidence of consent, including after account deletion. On deletion the record is severed from your account and kept in pseudonymized form: your user ID is removed and only a salted one-way hash remains, which cannot be reversed to identify you.
- **Account deletion:** When you delete your account, your personal data is deleted, except for the pseudonymized consent records described above and records retained as required by law. Anonymized, aggregated data that cannot identify you may be retained for platform analytics.

---

## 9. Data Security

We use reasonable administrative, technical, and organizational safeguards to protect your personal information, including industry-standard encryption of data in transit and at rest. Apple processes App Store payments, and RevenueCat manages subscription status, so your full card details never touch our servers.
...
Canceling your membership restricts access to paid features but does **not** delete your account or your personal data. To delete your personal data, request account deletion through your account settings or by contacting privacy@isofit.app. Section 8 explains what we may retain after deletion: pseudonymized consent records, records retained as required by law, and anonymized, aggregated data for platform analytics.

If you subscribed through the Apple App Store, deleting your Isofit account does **not** cancel that subscription — Apple manages it, and you must cancel it yourself in your Apple account settings (Settings → your name → Subscriptions on iPhone). RevenueCat manages subscription status on our behalf.
...
- **Withdraw Consent:** Withdraw any consent you have given at any time, including consent for Atlas personalization and Apple Health access. Effective for future processing.
