...
Each source screenshot is 1206 × 2622. The carousel displays the original aspect ratio, with arrows beside the phone and dots below the captions. Next.js handles delivery-size optimization.
